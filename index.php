...
include("connections.php");
    if ($name && $address && $email && $section && $contact) {
        ...
        $query = mysqli_query($connections, "INSERT INTO myinfo(name, address, email, section, contact) VALUES('$name','$address','$email','$section','$contact')");

        echo "<script language='javascript'>('New record has been inserted!')</script>";
        echo "<script>window.location.href='index.php';</script>";
    }

    $view_query = mysqli_query($connections, "SELECT * FROM myinfo");
